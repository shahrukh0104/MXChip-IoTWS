...
namespace DevKitTranslator
{
    public class SpeechTranslation
    {
        ...
        public async Task<string> TranslationWithAudioStreamAsync(Stream audioStream, string sourceLanguage = "en-US", string targetLanguage = "en-US")
        {
            ...
            using (var audioInput = OpenWavFile(audioStream))
            {
                ...
                using (var recognizer = new TranslationRecognizer(config, audioInput))
                {
                    ...
                    {
                        log.LogInformation($"RECOGNIZING in '{sourceLanguage}': Text = {e.Result.Text}");
                    ...
                    recognizer.Recognized += (s, e) =>
                    {
                        ...
                        {
                            log.LogInformation($"RECOGNIZED in '{sourceLanguage}': Text={e.Result.Text}");
                            foreach (var element in e.Result.Translations)
                            {
