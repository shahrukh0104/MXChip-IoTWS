...
namespace DevKitTranslator
{
    public static class DevKitTranslatorFunction
    {
        ...
        const string speechSubscriptionKey = "DIN AZURE SPEECH KEY HER";
        ...
        const string speechServiceRegion = "DIN VALGTE REGION";

        // Device ID
        const string deviceName = "DIN DEVICE NAME";
